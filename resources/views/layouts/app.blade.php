...
<head>
    ...
    <meta name="description" content="Café Management System">
    <meta name="author" content="vdoo.biz">
    <meta name="keyword" content="Café, Restaurant, Café Management System, Restaurant Management System">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/pos')}}"><i class="fa fa-cutlery text-success"></i> Point of Sales</a>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="fa fa-shopping-basket text-primary"></i> Product</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a href="#" class="nav-link nav-dropdown-toggle">
                        <i class="fa fa-dollar"></i> Payment</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
    ...
    <footer class="app-footer">
        Copyright &copy; {{date('Y')}} by <a href="http://www.arengcafe.com">Areng Cafe</a>
