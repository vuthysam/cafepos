                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/customer/update')}}" class="form-horizontal" method="post">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <input type="text" required autofocus name="name" id="name" class="form-control" value="{{$customers->name}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <input type="text" required name="phone" id="phone" class="form-control" value="{{$customers->phone}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <input type="text" name="card_number" id="card_number" class="form-control" value="{{$customers->card_number}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            <input type="text" name="discount" id="discount" class="form-control" value="{{$customers->discount}}">
                        </div>
                    </div>
                        <div class="form-group row">
